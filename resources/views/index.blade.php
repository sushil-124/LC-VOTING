...
<div class="filters flex space-x-6">
    ...
    <div class="w-1/3">
        <select name="filter" id="filter" class="w-full rounded-xl border-none px-4 py-2">
            <option value="One">Filter one</option>
            <option value="two">two</option>
            <option value="three">three</option>
            <option value="four">four</option>
        </select>
    ...
    <div class="w-2/3 relative">
        <input type="search" placeholder=" FInd an idea"
            class="w-full rounded-xl placeholder-gray-700 bg-white px-4 py-2 pl-8" id="">
        <div class="absolute top-0  flex items-center h-full ml-2">
            <svg class="w-4 text-gray" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                ...
                <div class=" w-full mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div x-data="{isOpen:false}" class="flex items-center space-x-2">
                            ...
                            <button @click="isOpen = !isOpen" class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in py-2 px-3">
